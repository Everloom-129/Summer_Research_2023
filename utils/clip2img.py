...
input_video_dir = "JAAD_clips" # "path_to_your_video_directory"
...
for video_file in video_files:
    ...
    # Calculate the frame interval for each second
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            if seq_num == math.floor(duration):  # if already saved images equals to seconds of the video, then break
                break
